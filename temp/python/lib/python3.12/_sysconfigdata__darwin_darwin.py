...
build_time_vars = {
    ...
    "ALT_SOABI": 0,
    "ANDROID_API_LEVEL": 0,
    "AR": "/tmp/tmpt_129jyz/tools/llvm/bin/llvm-ar",
    "ARFLAGS": "rcs",
    ...
    "CONFIG_ARGS": "'--build=aarch64-apple-darwin' '--host=aarch64-apple-darwin' '--prefix=/install' '--with-openssl=/tmp/tmpt_129jyz/tools/deps' '--with-system-expat' '--with-system-libmpdec' '--without-ensurepip' '--enable-static-libpython-for-interpreter' '--enable-shared' '--enable-optimizations' '--with-lto' '--with-build-python=/tmp/tmpt_129jyz/tools/host/bin/python3.12' 'ac_cv_lib_intl_textdomain=no' 'ac_cv_func_ptsname_r=no' '--with-dbmliborder=ndbm' 'build_alias=aarch64-apple-darwin' 'host_alias=aarch64-apple-darwin' 'PKG_CONFIG=pkg-config --static' 'PKG_CONFIG_PATH=/tmp/tmpt_129jyz/tools/deps/share/pkgconfig:/tmp/tmpt_129jyz/tools/deps/lib/pkgconfig' 'CC=clang' 'CFLAGS=-O3 -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new' 'LDFLAGS=-arch arm64 -mmacosx-version-min=11.0    -Wl,-headerpad,40' 'CPPFLAGS=-O3 -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new' 'PROFILE_TASK=-m test --pgo -j 12' 'BOLT_COMMON_FLAGS=' 'BOLT_APPLY_FLAGS='",
    "CONFINCLUDEDIR": "/install/include",
    "CONFINCLUDEPY": "/install/include/python3.12",
    "COREPYTHONPATH": "",
    "COVERAGE_INFO": "/private/tmp/tmpt_129jyz/Python-3.12.14/coverage.info",
    "COVERAGE_LCOV_OPTIONS": "--rc lcov_branch_coverage=1",
    "COVERAGE_REPORT": "/private/tmp/tmpt_129jyz/Python-3.12.14/lcov-report",
    ...
    "FILEMODE": 644,
    "FREEZE_MODULE": "/tmp/tmpt_129jyz/tools/host/bin/python3.12 ./Programs/_freeze_module.py",
    "FREEZE_MODULE_BOOTSTRAP": "/tmp/tmpt_129jyz/tools/host/bin/python3.12 ./Programs/_freeze_module.py",
    ...
    "LLVM_PROFDATA": "/tmp/tmpt_129jyz/tools/llvm/bin/llvm-profdata",
    "LLVM_PROF_ERR": "no",
    "LLVM_PROF_FILE": "LLVM_PROFILE_FILE=\"$(shell pwd)/code-%128m.profclangr\"",
    "LLVM_PROF_MERGER": "/tmp/tmpt_129jyz/tools/llvm/bin/llvm-profdata merge -output=\"$(shell pwd)/code.profclangd\" \"$(shell pwd)\"/*.profclangr",
    "LN": "ln",
    ...
    "PYTHONPATH": "",
    "PYTHON_FOR_BUILD": "_PYTHON_PROJECT_BASE=/private/tmp/tmpt_129jyz/Python-3.12.14 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/tmp/tmpt_129jyz/Python-3.12.14/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /tmp/tmpt_129jyz/tools/host/bin/python3.12",
    "PYTHON_FOR_BUILD_DEPS": "",
    "PYTHON_FOR_FREEZE": "/tmp/tmpt_129jyz/tools/host/bin/python3.12",
    "PYTHON_FOR_REGEN": "",
    "PYTHON_HEADERS": "\\",
    "PYTHON_OBJS": "\\",
    ...
    "PY_CFLAGS_NODIST": "-flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=/private/tmp/tmpt_129jyz/Python-3.12.14/code.profclangd -I./Include/internal",
    ...
    "RETSIGTYPE": "void",
    "RUNSHARED": "DYLD_LIBRARY_PATH=/private/tmp/tmpt_129jyz/Python-3.12.14",
    ...
    "TESTOPTS": "",
    "TESTPATH": "",
    "TESTPYTHON": "DYLD_LIBRARY_PATH=/private/tmp/tmpt_129jyz/Python-3.12.14 _PYTHON_PROJECT_BASE=/private/tmp/tmpt_129jyz/Python-3.12.14 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/tmp/tmpt_129jyz/Python-3.12.14/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /tmp/tmpt_129jyz/tools/host/bin/python3.12",
    "TESTPYTHONOPTS": "",
    "TESTRUNNER": "DYLD_LIBRARY_PATH=/private/tmp/tmpt_129jyz/Python-3.12.14 _PYTHON_PROJECT_BASE=/private/tmp/tmpt_129jyz/Python-3.12.14 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/tmp/tmpt_129jyz/Python-3.12.14/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /tmp/tmpt_129jyz/tools/host/bin/python3.12 ./Tools/scripts/run_tests.py",
    ...
    "abs_builddir": "/private/tmp/tmpt_129jyz/Python-3.12.14",
    "abs_srcdir": "/private/tmp/tmpt_129jyz/Python-3.12.14",
